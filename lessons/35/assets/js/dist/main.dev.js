...
//*************************/
$(function () {
  var val = $(".ol").attr("data-foo", "Hello");
  var text = $("ol li:first-child").html('<b>Hello</b>');
  $("#wrap").find('span').css('color', 'red'); // Застарілий запис
  ...
  $("#sq").css('color', 'blue').css('border', '2px solid green');
  $("#sq").css({
    'color': 'blue',
