...
var wrap = document.querySelector('#text_wrap');
wrap.append(div);
wrap.prepend(button);
var style = {
  body: {
...
applyStyle(style.button, button); // Создать html-страницу с progressbar и кнопкой, при нажатии на которую заполненность progressbar увеличивается на 5%.

var progress_wrap = document.querySelector('.progress_wrap');
var bar = document.createElement('div');
var scale = document.createElement('div');
var buttonForScale = document.createElement('button');
var buttonForScaleClean = document.createElement('button');
